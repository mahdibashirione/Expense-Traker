...
const Transactions = ({ type, time, value, inType, id, reason }) => {
  ...
  return (
    <li className="w-full py-2 flex gap-x-2 items-center justify-between nth-child2 px-2 rounded-lg">
      <div onClick={() => depositActions.removeHandler(id)} className="w-8 h-8 border-2 border-red-500 cursor-pointer hover:bg-red-300 rounded-lg flex items-center justify-center">
